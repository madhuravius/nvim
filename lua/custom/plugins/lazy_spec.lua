...

  {
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>bb', '<cmd>bp<cr>', desc = 'Previous Buffer', nowait = true, remap = false },
        { '<leader>bc', '<cmd>bd<cr>', desc = 'Close Buffer', nowait = true, remap = false },
        ...
        { '<leader>bn', '<cmd>bn<cr>', desc = 'Next Buffer', nowait = true, remap = false },
        { '<leader>c', '<cmd>bd<cr>', desc = 'Close', nowait = true, remap = false },
        ...
        { '<leader>tR', '<cmd>lua vim.lsp.buf.rename()<cr>', desc = 'Rename', nowait = true, remap = false },
